...
function CreateNotice() {
    ...
    return (
        <div className="min-h-[90vh] bg-bg flex flex-col items-start py-4 px-3 md:py-3 md:px-2 sm:py-2 sm:px-2 xs:py-2 xs:px-2">
            ...
            <div className={`w-full flex flex-col lg:flex-row gap-6 md:gap-4 sm:gap-3 xs:gap-2 justify-center ${formData.image ? 'max-w-5xl mx-auto' : 'max-w-4xl mx-auto'}`}>
                <form
                    onSubmit={handleSubmit}
                    className={`flex-1 ${formData.image ? 'lg:max-w-[50%]' : ''} p-4 lg:p-8 md:p-3 sm:p-2 xs:p-2 hide-scrollbar overflow-y-auto lg:max-h-[85vh]`}
                >
                    ...
                    <div className="mb-4 md:mb-3 sm:mb-2 xs:mb-2">
                        ...
                        <div className="w-full border border-borderSubtle rounded-md overflow-hidden bg-[var(--bg-color)] flex items-center px-2 lg:px-3 md:px-2 sm:px-1.5 xs:px-1.5 py-1.5 lg:py-2 md:py-1 sm:py-1 xs:py-1 cursor-pointer hover:shadow-sm transition">
                            <input
                                type="file"
                                name="image"
                                accept="image/*"
                    ...
                    {(formData.target === "students" || formData.target === "teachers" || formData.target === "all") && (
                ...
                {formData.image && (
                    <div className="flex justify-center items-start w-full lg:w-auto p-4 lg:p-8 md:p-3 sm:p-2 xs:p-2">
                        <div className="relative w-full max-w-lg h-auto lg:h-[70vh] border border-borderSubtle rounded-md overflow-hidden shadow hover:shadow-hover transition">
                            <img
